...
function removeFirstOccurrences(str, value) {
  const indexOfFirstOcc = str.indexOf(value);
  if (indexOfFirstOcc === -1) {
    return str;
  }
  return (
    str.substring(0, indexOfFirstOcc) +
    str.substring(indexOfFirstOcc + value.length)
  );
}
...
function removeLastOccurrences(str, value) {
  const indexOfFirstOcc = str.lastIndexOf(value);
  if (indexOfFirstOcc === -1) {
    return str;
  }
  return (
